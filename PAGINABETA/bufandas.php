...
<div class="banner-top">
    ...
    <div>
	    ...
	    $sql_consulta=" select a.id_producto,a.nombre,a.precio,a.stock,a.detalle,a.talla,a.foto,b.nom_proveedor,c.nombre_cat from productos a INNER JOIN proveedor b on (a.fk_proveedor=b.id_proveedor) 
		INNER JOIN categoria c on (a.fk_categoria=c.id_cat) where nombre_cat='Bufandas'";
...
<?php
  ...
  ?>
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="<?php echo "../Imagenes/productos/".$Datos_productos['foto'] ; ?>" class="img-responsive" alt="" style="max-width: 200px; max-height: 200px" >
						<div class="zoom-icon ">
 ...
 <form name="form2" method="post" autocomplete="off" enctype="multipart/form-data" action="ordenarsub3.php">
<SELECT NAME="categoria" SIZE=1 onChange="">
<OPTION VALUE="where nombre_cat='Bufandas'order by nombre asc">Nombre: de A a Z</OPTION>
<OPTION VALUE="where nombre_cat='Bufandas'order by nombre desc">Nombre: de Z a A </OPTION>
<OPTION VALUE="where nombre_cat='Bufandas'order by precio desc">Precio: Más caros primero</OPTION>
<OPTION VALUE="where nombre_cat='Bufandas'order by precio asc">Precio: Más baratos primero</OPTION>
<OPTION VALUE="where nombre_cat='Bufandas'order by talla asc">Talla</OPTION>
