...
<div class="banner-top">
    ...
    <div>
	    ...
	    $sql_consulta=" select a.id_producto,a.nombre,a.precio,a.stock,a.detalle,a.talla,a.foto,b.nom_proveedor from productos a INNER JOIN proveedor b on (a.fk_proveedor=b.id_proveedor)where a.nombre like '%".$_POST['nombre_producto']."%'";
