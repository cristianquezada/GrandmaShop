...
<div class="banner-top">
    ...
    <div>
		...
		INNER JOIN categoria c on (a.fk_categoria=c.id_cat) where nombre_cat='Chalecos';";
...
<form id="form2" action="ordenarsub.php" method="post">
<SELECT NAME="cate" SIZE=1 onChange="">
<OPTION VALUE="where nombre_cat='Chalecos'order by nombre asc">Nombre: de A a Z</OPTION>
<OPTION VALUE="where nombre_cat='Chalecos'order by nombre desc">Nombre: de Z a A </OPTION>
<OPTION VALUE="where nombre_cat='Chalecos'order by precio desc">Precio: Más baratos primero</OPTION>
<OPTION VALUE="where nombre_cat='Chalecos'order by precio asc">Precio: Más caros primero</OPTION>
<OPTION VALUE="where nombre_cat='Chalecos'order by talla asc">Talla</OPTION>
