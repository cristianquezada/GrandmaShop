...
<OPTION VALUE="where nombre_cat='Chalecos'order by precio desc">Precio: Más caros primero</OPTION>
<OPTION VALUE="where nombre_cat='Chalecos'order by precio asc">Precio: Más baratos primero</OPTION>
