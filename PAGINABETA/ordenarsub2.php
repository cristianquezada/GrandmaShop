...
<div class="banner-top">
    ...
    <div>
	   ...
	   $cat=$_POST['cate'];
	    ...
	    $sql_consulta="select a.id_producto,a.nombre,a.precio,a.stock,a.detalle,a.talla,a.foto,b.nom_proveedor,c.nombre_cat from productos a INNER JOIN proveedor b on (a.fk_proveedor=b.id_proveedor) INNER JOIN categoria c on (a.fk_categoria=c.id_cat) ".$cat."";
...
<form id="form2" action="ordenarsub2.php" method="post">
