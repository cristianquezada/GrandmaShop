...
<div class="banner-top">
    ...
    <div>
	   ...
	   $cate=$_POST['categoria'];
	    ...
	    $sql_consulta="select a.id_producto,a.nombre,a.precio,a.stock,a.detalle,a.talla,a.foto,b.nom_proveedor,c.nombre_cat from productos a INNER JOIN proveedor b on (a.fk_proveedor=b.id_proveedor) INNER JOIN categoria c on (a.fk_categoria=c.id_cat) ".$cate."";
...
<form id="form2" action="ordenarsub3.php" method="post">
...
<?php
  ...
  ?>
						...
						<a href="<?php echo $Datos_productos['../../PAGINABETA/nombre_cat'];?>.php"><?php echo $Datos_productos['nombre_cat'];?></a>
					</div>
