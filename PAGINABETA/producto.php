...
<div class="banner-top">
    ...
    <div>
	    ...
	    $sql_consulta=" select a.id_producto,a.nombre,a.precio,a.stock,a.detalle,a.talla,a.foto,b.nom_proveedor from productos a INNER JOIN proveedor b on (a.fk_proveedor=b.id_proveedor);";
...
<?php
  ...
  ?>
					...
					<div class=" mid-pop">
					<div class="pro-img">
						<img src="<?php echo "../Imagenes/productos/".$Datos_productos['foto'] ; ?>" class="img-responsive" alt="" style="max-width: 250px; max-height: 150px" >
						<div class="zoom-icon ">
						...
						<div class="women">
						<div class="women-top">
							<span>Talla: <?php echo $Datos_productos['talla'];?></span>
							<h6><?php echo $Datos_productos['nombre'];?></h6>
							</div>
							...
							<div class="mid-2">
								<p ><em class="item_price">Precio: $<?php echo $Datos_productos['precio'];?></em></p>
								  <div class="block">
  ...
  ?>
   ...
   <input class="form-control" name="nombre_producto" type="text"  id="nombre_producto" maxlength="50" />
