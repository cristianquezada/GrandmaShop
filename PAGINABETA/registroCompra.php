...
<div class="container">
    ...
    <table class="table-bordered" width="900" border="2" cellpadding="4" cellspacing="4" >
                  ...
                  <tr >
                    ...
                    <th width="73" align="center">Estado pedido</th>
  ...
  ?>
                  <tr  class="alt">
                    ...
                    <td align="center"><?php echo $Datos_productos['fechapedido'];?></td>
                        ...
                        <td align="center"><?php echo $Datos_productos['estado'];?></td>
                    ...
                    <td align="center"><p><a href="verPedidos.php?ID=<?php echo $Datos_productos['idpedido']; ?>">Ver</a></p>
                  </tr>
                  <?php
