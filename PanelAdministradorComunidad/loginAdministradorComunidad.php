...
<body>
  <div class="login">
    ...
    <form id="form1" name="form1" method="post" action="logearse.php">
        ...
        <button id="Ingresar" onClick="validar()" type="button" value="Ingresar" class="btn btn-primary btn-block btn-large">Iniciar Sesión</button>
    </form>
</div>
  
    <script  src="../../Probando/js/index.js"></script>
